...
export type FieldId = 'firstName' | 'lastName' | 'name' | 'slug' | 'emailAddress' | 'phoneNumber' | 'currentPassword' | 'newPassword' | 'signOutOfOtherSessions' | 'password' | 'confirmPassword' | 'identifier' | 'username' | 'code' | 'role';
export type ProfileSectionId = 'profile' | 'username' | 'emailAddresses' | 'phoneNumbers' | 'connectedAccounts' | 'enterpriseAccounts' | 'web3Wallets' | 'password' | 'mfa' | 'danger' | 'activeDevices' | 'organizationProfile' | 'organizationDanger';
